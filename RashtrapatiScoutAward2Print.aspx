<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RashtrapatiScoutAward2Print.aspx.cs" Inherits="RashtrapatiScoutAward5" %>
       ...
       <asp:DataList ID="DataList1" runat="server"  DataSourceID="SqlDataSource1" Width="100%">
        <ItemTemplate>
            <table style="width: 100%;">
                ...
                <tr>
                    <td><asp:Label ID="lblNameoftheScout" runat="server" CssClass="control-label "  Font-Size="Large" Font-Names="Times New Roman" 
  ...
  <caption>
    ...
    <table width="50%" align="right">
        ...
        <tr>
            ...
            <td align="center">
             <asp:Label ID="Label63" runat="server" class="control-label" Font-Size="Large" Text='<%#Eval("NameofScout") %>' Font-Names="Times New Roman"></asp:Label>
                </td>
           </tr>
       <%-- <tr>
        ...
        <tr>
            ...
            <td>
                 <asp:Label ID="Label68"  class="control-label" 
                    runat="server" Text='<%#Eval("NameofUnit") %>' 
                    Font-Bold="False" Font-Size="Large" Font-Names="Times New Roman"></asp:Label>
                </tr>
        <tr>
            <td >
