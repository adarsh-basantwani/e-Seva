  ...
  <div class="progress-bar" style="width: 100%;"></div>
   ...
   <div class="form-group">
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
        ...
        <td style=" border-collapse:collapse" class="style15">
        <asp:Label ID="OutwardToLabel" runat="server" Text='<%# Eval("OutwardTo") %>' CssClass=" control-label" />
                    
        </td>
        <td style=" border-collapse:collapse" class="style16">
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="SELECT OutwardDate, OutwardTo, OutwardAddress, Outwardtopic, OutwardFileNo, HowSend, Outletter, StampUsed, Ps, Stamppurchased, Ps1, RemainingStamp, Ps3, OutwardStatus, OLetterNo FROM OutwardLetter WHERE District=@District">
       <SelectParameters>
