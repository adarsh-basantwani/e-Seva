<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RSAListOfCandidates.aspx.cs" Inherits="RSAListOfCandidates" %>
...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <center>
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsRashtrapatiPuraskar" 
           DataTextField="NameofScout" DataValueField="NameofScout">
       </asp:CheckBoxList>
