    ...
    <fieldset>
       ...
       <div class="form-group">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT SrNo, Name, SchoolName, Address, Award, MeetingDate, ApplicationDate, Letter, Form, Certificate, District FROM GauravSevaPadak WHERE (Name = @Name) AND (District = @District)">
            <SelectParameters>
