  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT TrainingName FROM Office WHERE (TrainingName IS NOT NULL) AND (District = @District)">
            <SelectParameters>
    ...
    <asp:SqlDataSource ID="sqldsTraining" runat="server" 
                ...
                SelectCommand="SELECT Trainee, TrainingName FROM Office WHERE (TrainingName = @TrainingName) AND (District = @District)">
        <SelectParameters>
