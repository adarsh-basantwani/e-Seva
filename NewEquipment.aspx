    ...
    <fieldset>  <div class="form-group">
      ...
      <div class="col-lg-5 col-lg-offset-3">
        ...
        <asp:SqlDataSource ID="SqldsNewEquip" runat="server" 
            ...
            InsertCommand="INSERT INTO Office(NewEquipDate, NewEquipName, NewEquipPrice, NewEquipDescription, NewEquipBillNo, NewEquipQuantity, NewEquipTotalPrice, NewEquipPricePs, NewEquipTotalPricePs, District) VALUES (@NewEquipDate, @NewEquipName, @NewEquipPrice, @NewEquipDescription, @NewEquipBillNo, @NewEquipQuantity, @NewEquipTotalPrice, @NewEquipPricePs, @NewEquipTotalPricePs, @District)" 
