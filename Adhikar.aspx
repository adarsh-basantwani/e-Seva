...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT SchoolName FROM UnitLeaderTable WHERE (Year = @Year) AND (SchoolName IS NOT NULL) AND (District = @District)">
            <SelectParameters>
...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT UnitName FROM UnitLeaderTable WHERE (Year = @Year) AND (SchoolName = @SchoolName) AND (UnitName IS NOT NULL) AND (District = @District)">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList3" Name="Year" 
                    PropertyName="SelectedValue" Type="String" />
    ...
    <asp:SqlDataSource ID="SqlFullName" runat="server" 
        ...
        SelectCommand="SELECT [FullName], [Year], [SchoolName], [UnitName] FROM [UnitLeaderTable] WHERE (([SchoolName] = @SchoolName) AND ([UnitName] = @UnitName) AND ([Year] = @Year) AND (District = @District))">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList2" Name="SchoolName" 
                PropertyName="SelectedValue" Type="String" />
