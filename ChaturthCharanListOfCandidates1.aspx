...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown" 
       ...
       <td class="style1">
           ...
           <td>
           <a href='ChaturthCharan.aspx?NameOfTheCub=<%#Eval("NameOfTheCub") %>'><asp:label ID="label1" runat="server" Text="Click To See" CssClass="control-label"></asp:label></a>
           </td>
       </tr>
       </table>
        ...
        <asp:SqlDataSource ID="sqldsChaturthCharan" runat="server" 
           ...
           SelectCommand="SELECT NameOfTheCub FROM ChaturthCharan WHERE (Status = @Status) AND (NameOfTheDistrict = @District)">
            <SelectParameters>
