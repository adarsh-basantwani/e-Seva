    ...
    <asp:TextBox ID="txtPwd" runat="server" CssClass ="lf--input " 
      ...
      <asp:RequiredFieldValidator
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
            ...
            SelectCommand="SELECT SchoolType, Year, UnitType, UnitName, SchoolName, EmailId, Password, Zilla FROM SchoolTable WHERE (EmailId = @EmailId) AND (Password = @Password)">
            <SelectParameters>
                <asp:ControlParameter ControlID="txtUsername" Name="EmailId" 
                    PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="txtPwd" Name="Password" PropertyName="Text" 
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            SelectCommand="SELECT [District], [Address], [ContactNo], [EmailID], [Password] FROM [AuthTable] WHERE (([EmailID] = @EmailID) AND ([Password] = @Password))">
            <SelectParameters>
                <asp:ControlParameter ControlID="txtUsername" Name="EmailID" 
                    PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="txtPwd" Name="Password" PropertyName="Text" 
