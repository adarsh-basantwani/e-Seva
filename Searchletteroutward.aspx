...
<body>
  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <form id="form1" runat="server" class="form-horizontal">
     <asp:Label ID="Label7" runat="server" Text="0" CssClass="col-lg-3 control-label"></asp:Label>
    <fieldset>
    ...
    <div class="form-group">
        <asp:Label ID="lblSelect" runat="server" Text="Search By:" CssClass="col-lg-3 control-label"></asp:Label>
    ...
    <div class="col-lg-5">
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
            ...
            <asp:ListItem Value="2">LetterNo</asp:ListItem>
            <asp:ListItem Value="3">Receiver</asp:ListItem>
            <asp:ListItem Value="4">FileNo</asp:ListItem>
            <asp:ListItem Value="5">Status</asp:ListItem>
            <asp:ListItem Value="6">Topic</asp:ListItem>
        </asp:DropDownList>
    </div>
    </div>
   ...
   <tr>
        ...
        <asp:Label ID="OutwardLetterNo1Label" runat="server" 
                    Text='<%# Eval("OLetterNo") %>' CssClass="control-label" />
