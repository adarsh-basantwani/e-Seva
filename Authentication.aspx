        ...
        <div class="form-group">
          ...
          <div class="form-group">
             <asp:Label ID="lblDistrictSignature" runat="server"   class="col-lg-3 control-label" Text="District Signature"></asp:Label>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="FileUpload1" ForeColor="Red" >*</asp:RequiredFieldValidator>
           <div  class="col-lg-5">
      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" 
            ...
            <asp:SqlDataSource ID="Sqlds0" runat="server" 
                ...
                SelectCommand="SELECT [EmailID], [Password], [District] FROM [AuthTable] WHERE ([District] = @District)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="txtDistrict" Name="District" 
                        PropertyName="Text" Type="String" />
                </SelectParameters>
    ...
    <tr><td rowspan="2" width="107px" align="center">
     ...
     <center>   
         <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
             ...
             NavigateUrl="~/Login.aspx">Back</asp:HyperLink></center>
        </td><td width="228px">
     <center>   
