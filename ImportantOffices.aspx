  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <fieldset>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT OrganisationName, OrganisationAddress, HeadOfOrganisation, HeadContactNo, SrNo FROM Office WHERE (OrganisationName IS NOT NULL) AND (District = @District)" 
