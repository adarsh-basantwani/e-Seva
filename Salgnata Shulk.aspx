...
<form id="form1" runat="server" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <asp:SqlDataSource ID="Sqlds1" runat="server" 
            ...
            SelectCommand="SELECT SalgnataYear, SalgnataAmount, SalgnataReceiptNo, SalgnataReceiptNoDate FROM Office WHERE (SalgnataYear = @SalgnataYear) AND (District = @District)">
            <SelectParameters>
