   ...
   <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" 
       ...
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsMagzine" 
        ...
        <asp:SqlDataSource ID="sqldsMagzine" runat="server" 
           ...
           SelectCommand="SELECT DISTINCT SchoolName FROM SchoolTable WHERE (FeesPaidMagzine = @FeesPaidMagzine) AND (Year = @Year) AND (CheckedMagzine IS NULL) AND (Zilla = @Zilla)">
            <SelectParameters>
