...
<fieldset>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ...
            SelectCommand="SELECT NewEquipDate, NewEquipName, NewEquipPrice, NewEquipPricePs, NewEquipDescription, NewEquipBillNo, NewEquipQuantity, NewEquipTotalPrice, NewEquipTotalPricePs, SrNo FROM Office WHERE (NewEquipName IS NOT NULL) AND (District = @District)" 
