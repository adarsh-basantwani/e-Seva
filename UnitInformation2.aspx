  ...
  <h4> YEAR 
    ...
    <td style=" border-collapse:collapse" align="center" >
     <asp:Label ID="lbl11" runat="server" Text='<%#Eval("TotalFees") %>' CssClass="control-label"></asp:Label>
        ...
        SelectCommand="SELECT UnitType, TotalUnits, TotalStudent, StudentRegistrationFees, StudentTotalFees, TotalUnitLeader, TotalSupportingLeader, UnitLeaderRegistrationFees, UnitLeaderTotalFees, TotalMembers, TotalFees FROM UnitInformation WHERE (Year = @Year) AND (District = @District)">
        <SelectParameters>
