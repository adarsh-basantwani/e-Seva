...
<center><h3>MAHARASHTRA STATE BHARAT SCOUTS AND GUIDE<br /></h3><h4>YEAR - 
    ...
    <table width="100%">
    <tr><td class="style1"><h4>District:-
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                ...
                SelectCommand="SELECT DISTINCT UnitType FROM Confirmation WHERE (Year = @Year) AND (District = @District)">
            <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT UnitName, Students, UnitLeader, Total, TotalRs, Checked FROM Confirmation WHERE (UnitType = @UnitType) AND (Year = @Year) AND (District = @District)">
        <SelectParameters>
