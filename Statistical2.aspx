...
<div class="jumbotron">
    ...
    <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Year, Cub, Scout, Rover, Bulbul, Guide, Ranger, Bunny, Total, SrNo FROM StatisticalData WHERE (District = @District)" 
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT Year, Cub1, Scout1, Rover1, Bulbul1, Guide1, Ranger1, Bunny1, Total1, SrNo FROM StatisticalData WHERE (District = @District)" 
            DeleteCommand="DELETE FROM [StatisticalData] WHERE [SrNo] = @SrNo" 
       ...
       <br /><br />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            SelectCommand="SELECT [Year], [TotalUnits], [CollectedFees], [TotalParticipatedSchools], [SrNo] FROM [StatisticalData]WHERE (District = @District)" 
            DeleteCommand="DELETE FROM [StatisticalData] WHERE [SrNo] = @SrNo" 
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
            ...
            SelectCommand="SELECT Year, PrimarySchool, SecondarySchool, TotalMembers, SrNo FROM StatisticalData WHERE (District = @District)" 
            DeleteCommand="DELETE FROM [StatisticalData] WHERE [SrNo] = @SrNo" 
