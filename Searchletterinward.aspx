  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <asp:DataList ID="DataList2" runat="server" DataSourceID="SqlDataSource2" 
        ...
        <td style=" border-collapse:collapse" class="style1">
         <asp:Label ID="InwardNoLabel" runat="server" Text='<%# Eval("OInwardNo") %>' CssClass="col-lg-3 control-label" />       
        </td>
   ...
   <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT LetterAcceptingDate, LetterNo1, LetterDate, LetterFrom, InLetter, TopicLetter, FileNo, InwardStatus, District, OInwardNo FROM InwardLetters WHERE (FileNo LIKE '%' + @FileNo + '%') OR (InwardStatus LIKE '%' + @InwardStatus + '%') OR (LetterAcceptingDate LIKE '%' + @LetterAcceptingDate + '%') OR (LetterDate LIKE '%' + @LetterDate + '%') OR (LetterFrom LIKE '%' + @LetterFrom + '%') OR (LetterNo1 LIKE '%' + @LetterNo1 + '%') OR (TopicLetter LIKE '%' + @TopicLetter + '%') AND (District = @District)">
       <SelectParameters>
