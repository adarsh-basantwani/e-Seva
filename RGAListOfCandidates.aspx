<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RGAListOfCandidates.aspx.cs" Inherits="RGAListOfCandidates" %>
...
<form id="form1" runat="server" class="form-horizontal">
   <fieldset>
   <center>
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsRashtrapatiPuraskar" 
           DataTextField="NameofGuide" DataValueField="NameofGuide">
       </asp:CheckBoxList>
