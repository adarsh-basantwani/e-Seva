    ...
    <div class="col-lg-5">
       <asp:DropDownList ID="DropDownList2" runat="server" CssClass="dropdown">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT MaintainanceDate, MaintainanceAmount FROM Office WHERE (MaintainanceYear = @MaintainanceYear) AND (MaintainanceType = @MaintainanceType) AND (District = @District)">
            <SelectParameters>
