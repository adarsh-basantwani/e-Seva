...
public partial class RGAListOfCandidates : System.Web.UI.Page
{
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListItem li in CheckBoxList1.Items)
        {
            if (li.Selected == true)
            {
                String sql = "update RashtrapatiPuraskarGuide set Status='Pass' WHERE NameofGuide='" + li.Text + "' AND District='" + s + "'";
