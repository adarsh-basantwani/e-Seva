      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:SqlDataSource ID="SqldsSalgnataShulk" runat="server" 
                ...
                InsertCommand="INSERT INTO Office(SalgnataYear, SalgnataAmount, SalgnataReceiptNo, SalgnataReceiptNoDate, District) VALUES (@SalgnataYear, @SalgnataAmount, @SalgnataReceiptNo, @SalgnataReceiptNoDate, @District)" 
