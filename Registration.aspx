...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT Taluka FROM SchoolTable WHERE (Year = @Year) AND (Taluka IS NOT NULL) AND (Zilla = @Zilla)">
            <SelectParameters>
...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT UnitType FROM SchoolTable WHERE (Year = @Year) AND (Taluka = @Taluka) AND (UnitType IS NOT NULL) AND (Zilla = @Zilla)">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList1" Name="Year" 
                    PropertyName="SelectedValue" Type="String" />
    ...
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
        ...
        SelectCommand="SELECT SchoolName, UnitName, CharterNo, WarrantNo, EmailId, Password, Status FROM SchoolTable WHERE (Year = @Year) AND (Taluka = @Taluka) AND (UnitType = @UnitType) AND (Zilla = @Zilla)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList1" Name="Year" 
                PropertyName="SelectedValue" Type="String" />
            <asp:ControlParameter ControlID="DropDownList2" Name="Taluka" 
