  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="form-group">
        <asp:Label ID="lblSelectDate" runat="server" Text="Select Date" CssClass="col-lg-3 control-label"></asp:Label>
         ...
         <div class="col-lg-5">
                ...
                <asp:SqlDataSource ID="Sqlds" runat="server" 
                    ...
                    SelectCommand="SELECT Date FROM Office WHERE (ArrangedProgram IS NOT NULL) AND (Date IS NOT NULL) AND (District = @District)">
                    <SelectParameters>
        ...
        <asp:SqlDataSource ID="Sqlds1" runat="server" 
            ...
            SelectCommand="SELECT DayName, Date, ArrangedProgram, ProgramAttendance, Place, ProgramReport, ProgramPhoto FROM Office WHERE (Date = @Date) AND (District = @District)">
            <SelectParameters>
