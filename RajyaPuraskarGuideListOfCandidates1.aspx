...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown" 
       ...
       <td class="style1">
           ...
           <td>
           <a href='RajyaPuraskarGuide.aspx?NameOfTheGuide=<%#Eval("NameOfTheGuide") %>'>Click To See</a>
           </td>
       </tr>
       </table>
        ...
        <asp:SqlDataSource ID="sqldsChaturthCharan" runat="server" 
           ...
           SelectCommand="SELECT NameOfTheGuide FROM RajyaPuraskarGuide WHERE (Status = @Status) AND (District = @District)">
            <SelectParameters>
