      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" 
            ...
            <asp:SqlDataSource ID="SqldsMasikAhwal" runat="server" 
                ...
                InsertCommand="INSERT INTO Office(EmployeeName, SendingDate, EmployeeReport, MasikAhwalYear, District) VALUES (@EmployeeName, @SendingDate, @EmployeeReport, @MasikAhwalYear, @District)" 
