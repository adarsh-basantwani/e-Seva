       ...
       <div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                SelectCommand="SELECT FullName FROM UnitLeaderTable WHERE (SchoolName = @SchoolName) AND (UnitName = @UnitName) AND (Year = @Year) AND (FullName IS NOT NULL) AND (District = @District)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownList2" Name="SchoolName" 
                        PropertyName="SelectedValue" Type="String" />
