        ...
        <div class="form-group">
            <div class="col-lg-5">
                <asp:SqlDataSource ID="SqlDsTraining" runat="server" 
                    ...
                    InsertCommand="INSERT INTO Office(TrainingName, Trainee, TrainDuration, TrainCertificateNo, TrainDate, Trainhead, TrainPlace, TrainCertificate, District) VALUES (@TrainingName, @Trainee, @TrainDuration, @TrainCertificateNo, @TrainDate, @Trainhead, @TrainPlace, @TrainCertificate, @District)" 
                    SelectCommand="SELECT [SrNo], [TrainingName], [Trainee], [TrainDuration], [TrainCertificateNo], [TrainDate], [Trainhead], [TrainPlace], [TrainCertificate] FROM [Office]" 
                    UpdateCommand="UPDATE [Office] SET [TrainingName] = @TrainingName, [Trainee] = @Trainee, [TrainDuration] = @TrainDuration, [TrainCertificateNo] = @TrainCertificateNo, [TrainDate] = @TrainDate, [Trainhead] = @Trainhead, [TrainPlace] = @TrainPlace, [TrainCertificate] = @TrainCertificate WHERE [SrNo] = @SrNo">
                    <DeleteParameters>
