...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [District], [Address], [ContactNo] FROM [AuthTable] WHERE (([EmailID] = @EmailID) AND ([Password] = @Password))">
    <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
    ...
    SelectCommand="SELECT [CharterNo], [WarrantNo], [EmailId], [Password], [Zilla] FROM [SchoolTable] WHERE (([EmailId] = @EmailId) AND ([Password] = @Password))">
    <SelectParameters>
        <asp:ControlParameter ControlID="hfUserId" Name="EmailId" PropertyName="Value" 
            Type="String" />
        <asp:ControlParameter ControlID="hfPwd" Name="Password" PropertyName="Value" 
