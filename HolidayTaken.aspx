        ...
        <div class="form-group">
         ...
         <asp:Button ID="btn1" runat="server" Text="Cancel" CssClass="btn btn-default" />
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btn2_Click" />
                ...
                UpdateCommand="UPDATE Office SET HolidayTakenArjit = HolidayTakenArjit + @HolidayTakenArjit, HolidayTakenVaidyakiya = HolidayTakenVaidyakiya + @HolidayTakenVaidyakiya, HolidayTakenKirkod = HolidayTakenKirkod + @HolidayTakenKirkod WHERE (HolidayYear = @HolidayYear) AND (HolidayEmployeeName = @HolidayEmployeeName) AND (Arjit IS NOT NULL) AND District=@District">
                    <DeleteParameters>
                ...
                UpdateCommand="UPDATE Office SET RemainingVaidyakiya = RemainingVaidyakiya - @RemainingVaidyakiya, RemainingArjit = RemainingArjit - @RemainingArjit, RemainingKirkod = RemainingKirkod - @RemainingKirkod WHERE (HolidayYear = @HolidayYear) AND (HolidayEmployeeName = @HolidayEmployeeName) AND (Arjit IS NOT NULL) AND (District = @District)">
                    <DeleteParameters>
                        <asp:Parameter Name="SrNo" Type="Int32" />
                    </DeleteParameters>
                    <InsertParameters>
                ...
                SelectCommand="SELECT RemainingArjit, RemainingVaidyakiya, RemainingKirkod FROM Office WHERE (HolidayYear = @HolidayYear) AND (HolidayEmployeeName = @HolidayEmployeeName) AND (Arjit IS NOT NULL) AND (District = @District)">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="DropDownList1" Name="HolidayYear" 
                            PropertyName="SelectedValue" Type="String" />
                        <asp:ControlParameter ControlID="DropDownList2" Name="HolidayEmployeeName" 
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                DeleteCommand="DELETE FROM [Office] WHERE [SrNo] = @SrNo" 
                InsertCommand="INSERT INTO Office(HolidayYear, HolidayEmployeeName, HolidayDate, HolidayReason, District) VALUES (@HolidayYear, @HolidayEmployeeName, @HolidayDate, @HolidayReason, @District)" 
