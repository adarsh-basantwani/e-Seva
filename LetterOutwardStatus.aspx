  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <center>
        ...
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" 
            DataSourceID="SqlDataSource1" DataTextField="OLetterNo" 
            DataValueField="OLetterNo">
        </asp:CheckBoxList>
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [OLetterNo] FROM [OutwardLetter] WHERE (([OutwardStatus] = @OutwardStatus) AND ([District] = @District))">
             <SelectParameters>
