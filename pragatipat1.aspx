  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="form-group">
        ...
        <asp:SqlDataSource ID="SqldsPragatiPat" runat="server" 
            ...
            UpdateCommand="UPDATE SchoolTable SET PragatiPatParticipants = @PragatiPatParticipants, PragatiPatCertificateNo = @PragatiPatCertificateNo, PragatiPatDate = @PragatiPatDate, PragatiPatExaminerName = @PragatiPatExaminerName, PragatiPatLetter = @PragatiPatLetter, Zilla = @Zilla WHERE (EmailId = @EmailId) AND (Password = @Password)">
            <DeleteParameters>
