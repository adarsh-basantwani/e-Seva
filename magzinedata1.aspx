    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DISTINCT SchoolName FROM SchoolTable WHERE (FeesPaidMagzine = @FeesPaidMagzine) AND (Year = @Year) AND (SchoolName IS NOT NULL) AND (Zilla = @Zilla)">
                    <SelectParameters>
        ...
        <asp:Button ID="btn1" runat="server" Text="Cancel" CssClass="btn btn-default" />
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btn2_Click" />
            ...
            UpdateCommand="UPDATE SchoolTable SET FeesPaidMagzine = @FeesPaidMagzine WHERE (SchoolName = @SchoolName) AND (Year = @Year) AND (Zilla = @Zilla)">
                <DeleteParameters>
