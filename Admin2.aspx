...
<body style=" width: 100%; height: 100%; top: 100%; right: 100%; bottom: 100%; left: 100%;">
        ...
        <div class="featurette" id="about">
            ...
            Orientation="Horizontal" BackColor="#EEEEEE" Font-Bold="False" Width="100%" 
                 ...
                 <asp:MenuItem Text="List of Candidates" Value="List of Candidates" 
                    ...
                    <asp:MenuItem Text="Change Status of Candidates" 
                     ...
                     <asp:MenuItem Text="Chaturth Charan" Value="Rashtrapati Puraskar">
                         <asp:MenuItem NavigateUrl="~/ChaturthCharanListOfCandidates1.aspx" 
                             Text="List of Candidates" Value="List of Candidates"></asp:MenuItem>
                         <asp:MenuItem NavigateUrl="~/ChaturthCharanListOfCandidates.aspx?Status=Not Qualified" 
                             Text="Change Status of Candidates" Value="Change Status of Candidates">
                         </asp:MenuItem>
                     </asp:MenuItem>
                ...
                <asp:MenuItem Text="Rajya Puraskar for Scout" Value="Scout">
                 ...
                 <asp:MenuItem Text="Rashtrapati Puraskar for Scout" 
                         Value="Rashtrapati Puraskar for Scout">
                     <asp:MenuItem NavigateUrl="~/RSAListOfCandidates1.aspx" 
                         Text="List of Candidates" Value="List of Candidates"></asp:MenuItem>
                     <asp:MenuItem NavigateUrl="~/RSAListOfCandidates.aspx?Status=Not Qualified" 
                         Text="Change Status of Candidates" Value="Change Status of Candidates">
                     </asp:MenuItem>
                     </asp:MenuItem>
                    <asp:MenuItem Text="Rashtrapati Puraskar for Guide" 
                         Value="Rashtrapati Puraskar for Guide">
                        <asp:MenuItem NavigateUrl="~/RGAListOfCandidates1.aspx" 
                            Text="List of Candidates" Value="List of Candidates"></asp:MenuItem>
                        <asp:MenuItem NavigateUrl="~/RGAListOfCandidates.aspx?Status=Not Qualified" 
                            Text="Change Status of Candidates" Value="Change Status of Candidates">
                        </asp:MenuItem>
                     </asp:MenuItem>
  ...
  <div class="panel-body">
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT MeetingDate, NameOfMeeting FROM Office WHERE (District = @District)">
          <SelectParameters>
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
          ...
          SelectCommand="SELECT Date, DayName FROM Office WHERE (District = @District)">
          <SelectParameters>
              <asp:SessionParameter Name="District" SessionField="District" />
          </SelectParameters>
      </asp:SqlDataSource>
