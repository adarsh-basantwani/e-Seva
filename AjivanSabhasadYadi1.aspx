      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" 
           ...
           <asp:SqlDataSource ID="SqldsAjivan" runat="server" 
               ...
               InsertCommand="INSERT INTO Office(MemberName, MemberAddress, EmailId, MembershipDate, ContactNumber, District) VALUES (@MemberName, @MemberAddress, @EmailId, @MembershipDate, @ContactNumber, @District)" 
