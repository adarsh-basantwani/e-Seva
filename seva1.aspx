    ...
    <asp:Label ID="lblSelectSchoolName" runat="server" Text="Select School Name" CssClass="col-lg-3 control-label  "></asp:Label>
          ...
          <div class="col-lg-5">
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  SelectCommand="SELECT DISTINCT SchoolName FROM SchoolTable WHERE (Year = @Year) AND (SchoolName IS NOT NULL) AND (Zilla = @Zilla)">
                  <SelectParameters>
          ...
          <div class="col-lg-5">
              ...
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ...
                  SelectCommand="SELECT UnitName FROM SchoolTable WHERE (SchoolName = @SchoolName) AND (Year = @Year) AND (UnitName IS NOT NULL) AND (Zilla = @Zilla)">
                  <SelectParameters>
                      <asp:ControlParameter ControlID="DropDownList1" Name="SchoolName" 
                          PropertyName="SelectedValue" Type="String" />
                      <asp:ControlParameter ControlID="DropDownList3" Name="Year" 
                          PropertyName="SelectedValue" Type="String" />
                      <asp:SessionParameter Name="Zilla" SessionField="Zilla" />
                  </SelectParameters>
              </asp:SqlDataSource>
              </div></div>
