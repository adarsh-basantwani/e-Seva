...
<div class="form-group">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT UnitName FROM UnitLeaderTable WHERE (SchoolName = @SchoolName) AND (Year = @Year) AND (UnitName IS NOT NULL) AND (District = @District)">
            <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlFullName" runat="server" 
        ...
        SelectCommand="SELECT FullName, Year FROM UnitLeaderTable WHERE (Year = @Year) AND (SchoolName = @SchoolName) AND (UnitName = @UnitName) AND (District = @District)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList3" Name="Year" 
                PropertyName="SelectedValue" Type="String" />
            <asp:ControlParameter ControlID="DropDownList1" Name="SchoolName" 
