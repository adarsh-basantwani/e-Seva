        ...
        <asp:Button ID="btn1" runat="server" Text="Cancel" CssClass="btn btn-default" />
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btn2_Click" />
                 <asp:SqlDataSource ID="SqlDsKhariKamai" runat="server" 
                     ...
                     UpdateCommand="UPDATE SchoolTable SET khTotalContri = @khTotalContri, khUnitContri = @khUnitContri, khDistrictContri = @khDistrictContri, khStateContri = @khStateContri WHERE (EmailId = @EmailId) AND (Password = @Password) AND (Zilla = @Zilla)">
                     <DeleteParameters>
