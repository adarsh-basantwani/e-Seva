    ...
    <legend> <asp:Label ID="lblMembersInformation" runat="server" Font-Names="Arial Black" Font-Size="Medium" Text="8. Member's Information"></asp:Label>
      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            InsertCommand="INSERT INTO StudentTable(StudFullName, StudDOB, StudStandard, SchoolName, UnitName, Year, UnitType, EmailId, Password, District) VALUES (@StudFullName, @StudDOB, @StudStandard, @SchoolName, @UnitName, @Year, @UnitType, @EmailId, @Password, @District)" 
