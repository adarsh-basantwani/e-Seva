...
<fieldset>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ...
            SelectCommand="SELECT InwardEquipDate, InwardEquipName, InwardEquipPrice, InwardEquipPricePs, InwardEquipDescription, InwardEquipBillNo, InwardEquipQuantity, InwardEquipTotalPrice, InwardEquipTotalPricePs, SrNo FROM Office WHERE (InwardEquipName IS NOT NULL) AND (District = @District)" 
