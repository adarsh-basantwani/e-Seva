...
<body style=" width: 100%; height: 100%; top: 100%; right: 100%; bottom: 100%; left: 100%;">
  ...
  <asp:Label ID="Label1" runat="server" Text="" Font-Bold="True" Font-Size="XX-Large"  width="1000px" ForeColor="Black"  Font-Names="Arial" BackColor="#003366" BorderWidth="2px" BorderStyle="Groove" BorderColor="Black"></asp:Label></marquee>
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
          
          
          SelectCommand="SELECT Post, PostDate FROM Office WHERE (Post IS NOT NULL) AND (District = @District)">
          <SelectParameters>
