    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dv.Count; i++)
        {
            if (dv[i][0] != DBNull.Value)
            {
                ...
                String sql1 = "select count(UnitName) from SchoolTable where UnitType='Cub' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                SqlDataSource1.SelectCommand = sql1;
                DataView dv1 = (DataView)SqlDataSource1.Select(new DataSourceSelectArguments());
                int cub = (int)dv1[0][0];

                String sql2 = "select count(UnitName) from SchoolTable where UnitType='Scout' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql3 = "select count(UnitName) from SchoolTable where UnitType='Rover' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql4 = "select count(UnitName) from SchoolTable where UnitType='Bulbul' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql5 = "select count(UnitName) from SchoolTable where UnitType='Guide' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql6 = "select count(UnitName) from SchoolTable where UnitType='Ranger' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql7 = "select count(UnitName) from SchoolTable where UnitType='Bunny' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql9 = "select count(StudFullName) from StudentTable where UnitType='Cub' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql10 = "select count(StudFullName) from StudentTable where UnitType='Scout' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql11 = "select count(StudFullName) from StudentTable where UnitType='Rover' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql12 = "select count(StudFullName) from StudentTable where UnitType='Bulbul' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql13 = "select count(StudFullName) from StudentTable where UnitType='Guide' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql14 = "select count(StudFullName) from StudentTable where UnitType='Ranger' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql15 = "select count(StudFullName) from StudentTable where UnitType='Bunny' AND Year='" + year + "' AND Status='Activated' AND District='" + s + "'";
                ...
                String sql16 = "select count(UnitName) from SchoolTable where Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql17 = "select SUM(khTotalContri) from SchoolTable where Year='" + year + "' AND Zilla='" + s + "'";
                ...
                String sql18 = "select count(SchoolName) from SchoolTable where Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql19 = "select count(SchoolName) from SchoolTable where SchoolType='PrimarySchool' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                String sql20 = "select count(SchoolName) from SchoolTable where SchoolType='SecondarySchool' AND Year='" + year + "' AND Status='Activated' AND Zilla='" + s + "'";
                ...
                if (dv21.Count!=0)
                {
                    String query="update StatisticalData set Cub="+cub+", Scout="+scout+", Rover="+rover+", Bulbul="+bulbul+", Guide="+guide+", Ranger="+ranger+", Bunny="+bunny+", Total="+total+", Cub1="+cub1+", Scout1="+scout1+", Rover1="+rover1+", Bulbul1="+bulbul1+", Guide1="+guide1+", Ranger1="+ranger1+", Bunny1="+bunny1+", Total1="+total1+", TotalUnits="+unit+", CollectedFees="+amt+", TotalParticipatedSchools="+sch+", PrimarySchool="+sch1+", SecondarySchool="+sch2+", TotalMembers="+total3+", District='" + s + "' where Year='"+year+"'";
                ...
                {
                    String insert1 = "insert into StatisticalData (Year, Cub, Scout, Rover, Bulbul, Guide, Ranger, Bunny, Total, Cub1, Scout1, Rover1, Bulbul1, Guide1, Ranger1, Bunny1, Total1, TotalUnits, CollectedFees, TotalParticipatedSchools, PrimarySchool, SecondarySchool, TotalMembers, District) Values('" + year + "'," + cub + "," + scout + "," + rover + "," + bulbul + "," + guide + "," + ranger + "," + bunny + "," + total + "," + cub1 + "," + scout1 + "," + rover1 + "," + bulbul1 + "," + guide1 + "," + ranger1 + "," + bunny1 + "," + total1 + "," + unit + "," + amt + "," + sch + "," + sch1 + "," + sch2 + "," + total3 + ",'" + s + "')";
