    ...
    <div class="form-group">
            ...
            <div class="col-lg-5">
                ...
                <asp:SqlDataSource ID="Sqlds" runat="server" 
                    ...
                    SelectCommand="SELECT MeetingDate FROM Office WHERE (MeetingReport IS NULL) AND (MeetingDate IS NOT NULL) AND (District = @District)">
                    <SelectParameters>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT NameOfMeeting FROM Office WHERE (MeetingDate = @MeetingDate) AND (NameOfMeeting IS NOT NULL) AND (District = @District)">
                    <SelectParameters>
     ...
     <div class="form-group">
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:SqlDataSource ID="SqlDsMeetings" runat="server" 
              ...
              UpdateCommand="UPDATE Office SET Attendance = @Attendance, MeetingReport = @MeetingReport, MeetingAgenda = @MeetingAgenda WHERE (MeetingDate = @MeetingDate) AND (NameOfMeeting = @NameOfMeeting) AND (District = @District)">
              <DeleteParameters>
