  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <fieldset>
        ...
        <td>
            ...
            SelectCommand="SELECT VarshikAnudanDate, VarshikAnudanAmount FROM Office WHERE (UtilizationCertificate IS NULL) AND (VarshikAnudanDate IS NOT NULL) AND (District = @District)">
                <SelectParameters>
