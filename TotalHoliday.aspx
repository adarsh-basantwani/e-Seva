         ...
         <asp:Button ID="btn1" runat="server" Text="Cancel" CssClass="btn btn-default" />
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btn2_Click" />
                ...
                <asp:SqlDataSource ID="SqlDsHolidays" runat="server" 
                    ...
                    InsertCommand="INSERT INTO Office(HolidayYear, HolidayEmployeeName, Arjit, Vaidyakiya, Kirkod, District) VALUES (@HolidayYear, @HolidayEmployeeName, @Arjit, @Vaidyakiya, @Kirkod, @District)" 
            ...
            <asp:SqlDataSource ID="Sqldsremaining" runat="server" 
                ...
                UpdateCommand="UPDATE [Office] SET [RemainingArjit] = @RemainingArjit, [RemainingVaidyakiya] = @RemainingVaidyakiya, [RemainingKirkod] = @RemainingKirkod WHERE [HolidayYear] = @HolidayYear AND [HolidayEmployeeName] = @HolidayEmployeeName AND District=@District">
                <DeleteParameters>
                    <asp:Parameter Name="SrNo" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
