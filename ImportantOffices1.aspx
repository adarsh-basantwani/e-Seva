      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" 
            ...
            <asp:SqlDataSource ID="SqldsImportantOffices" runat="server" 
                ...
                InsertCommand="INSERT INTO Office(OrganisationName, OrganisationAddress, HeadOfOrganisation, HeadContactNo, District) VALUES (@OrganisationName, @OrganisationAddress, @HeadOfOrganisation, @HeadContactNo, @District)" 
