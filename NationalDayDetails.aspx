     ...
     <asp:Label ID="lblSelectDate" runat="server"  CssClass="col-lg-3 control-label" 
            ...
            <div class="col-lg-5">
                ...
                <asp:SqlDataSource ID="Sqlds" runat="server" 
                    ...
                    SelectCommand="SELECT Date FROM Office WHERE (ArrangedProgram IS NULL) AND (Date IS NOT NULL) AND (District = @District)">
                    <SelectParameters>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:SqlDataSource ID="SqldsNationalDays" runat="server" 
              ...
              UpdateCommand="UPDATE Office SET ArrangedProgram = @ArrangedProgram, ProgramAttendance = @ProgramAttendance, Place = @Place, ProgramReport = @ProgramReport, ProgramPhoto = @ProgramPhoto WHERE (Date = @Date) AND (District = @District)">
              <DeleteParameters>
