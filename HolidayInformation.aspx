  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT HolidayEmployeeName, HolidayDate, HolidayReason FROM Office WHERE (HolidayYear = @HolidayYear) AND (HolidayDate IS NOT NULL) AND (District = @District)">
            <SelectParameters>
