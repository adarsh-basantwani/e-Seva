    ...
    <fieldset>
       ...
       <div class="form-group">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT TrainingName, Trainee, TrainDuration, TrainCertificateNo, TrainDate, Trainhead, TrainPlace, TrainCertificate FROM Office WHERE (TrainingName = @TrainingName) AND (Trainee = @Trainee) AND (District = @District)">
            <SelectParameters>
