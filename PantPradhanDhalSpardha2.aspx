    ...
    <fieldset>
       ...
       <div class="form-group">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT SchoolTable.PermanentAddress, UnitLeaderTable.UnitName, UnitLeaderTable.SubjectNo, UnitLeaderTable.OptionalSubjectNo, UnitLeaderTable.Attendance, UnitLeaderTable.FullName, UnitLeaderTable.PantPradhanLetter FROM SchoolTable INNER JOIN UnitLeaderTable ON SchoolTable.UnitName = UnitLeaderTable.UnitName WHERE (UnitLeaderTable.FullName = @FullName) AND (UnitLeaderTable.Year = @Year) AND (UnitLeaderTable.District = @District)">
            <SelectParameters>
