    ...
    <div class="col-lg-5">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Arjit" HeaderText="Arjit(Total)" 
                    SortExpression="Arjit" />
                <asp:BoundField DataField="Vaidyakiya" HeaderText="Vaidyakiya(Total)" 
                    SortExpression="Vaidyakiya" />
                <asp:BoundField DataField="Kirkod" HeaderText="Kirkod(Total)" 
                    SortExpression="Kirkod" />
                <asp:BoundField DataField="HolidayTakenArjit" HeaderText="Arjit(Taken)" 
                    SortExpression="HolidayTakenArjit" />
                <asp:BoundField DataField="HolidayTakenVaidyakiya" 
                    HeaderText="Vaidyakiya(Taken)" SortExpression="HolidayTakenVaidyakiya" />
                <asp:BoundField DataField="HolidayTakenKirkod" HeaderText="Kirkod(Taken)" 
                    SortExpression="HolidayTakenKirkod" />
                <asp:BoundField DataField="RemainingArjit" HeaderText="Arjit(Remaining)" 
                    SortExpression="RemainingArjit" />
                <asp:BoundField DataField="RemainingVaidyakiya" 
                    HeaderText="Vaidyakiya(Remaining)" SortExpression="RemainingVaidyakiya" />
                <asp:BoundField DataField="RemainingKirkod" HeaderText="Kirkod(Remaining)" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT HolidayYear, HolidayEmployeeName, Arjit, Vaidyakiya, Kirkod, HolidayTakenArjit, HolidayTakenVaidyakiya, HolidayTakenKirkod, RemainingArjit, RemainingVaidyakiya, RemainingKirkod, SrNo FROM Office WHERE (HolidayYear = @HolidayYear) AND (Arjit IS NOT NULL) AND (District = @District)" 
