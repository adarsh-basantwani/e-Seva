...
<div class="jumbotron">
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                ...
                SelectCommand="SELECT LetterAcceptingDate, LetterNo1, LetterDate, LetterFrom, InLetter, TopicLetter, FileNo, InwardStatus, District, OInwardNo FROM InwardLetters WHERE (District = @District)">
       <SelectParameters>
