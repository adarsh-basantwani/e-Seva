...
<div class="jumbotron">
    ...
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ...
            SelectCommand="SELECT SchoolName, UnitName, UnitType, StudFullName, StudDOB, StudStandard FROM StudentTable WHERE (Year = @Year) AND (StudStandard = @StudStandard) AND (District = @District)">
            <SelectParameters>
                <asp:ControlParameter ControlID="ddlYear" Name="Year" 
                    PropertyName="SelectedValue" Type="String" />
