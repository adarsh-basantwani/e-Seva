...
public partial class Confirmation2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Label6.Text = (String)Session["District"];
        ...
        String Sql = "Select Sum(Students), Sum(UnitLeader), Sum(Total), Sum(TotalRs) from Confirmation where UnitType='" + utype + "' AND Year='" + Year + "' AND District='" + s + "'";
