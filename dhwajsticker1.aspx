    ...
    <fieldset>
      ...
      <div class="col-lg-5 col-lg-offset-3">
          ...
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" 
            ...
            UpdateCommand="UPDATE SchoolTable SET NoOfStickers = @NoOfStickers, DhwajStickerFees = @DhwajStickerFees, DhwajStickerDistrictLevel = @DhwajStickerDistrictLevel, DhwajStickerStateLevel = @DhwajStickerStateLevel WHERE (EmailId = @EmailId) AND (Password = @Password) AND (Zilla = @Zilla)">
                    <DeleteParameters>
