    ...
    <div class="form-group">
        ...
        <asp:TextBox ID="txtReceiptNoDate" runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                InsertCommand="INSERT INTO Office(DonationYear, DonationName, DonationPurpose, DonationAmount, DonationReceiptNo, DonationReceiptNoDate, District) VALUES (@DonationYear, @DonationName, @DonationPurpose, @DonationAmount, @DonationReceiptNo, @DonationReceiptNoDate, @District)" 
