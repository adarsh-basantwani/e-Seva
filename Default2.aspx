...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [Confirmation]" 
            InsertCommand="INSERT INTO [Confirmation] ([UnitName], [Students], [UnitLeader], [Total], [TotalRs], [Year], [UnitType], [Checked], [District]) VALUES (@UnitName, @Students, @UnitLeader, @Total, @TotalRs, @Year, @UnitType, @Checked, @District)" 
            SelectCommand="SELECT * FROM [Confirmation]" 
            UpdateCommand="UPDATE [Confirmation] SET [UnitName] = @UnitName, [Students] = @Students, [UnitLeader] = @UnitLeader, [Total] = @Total, [TotalRs] = @TotalRs, [Year] = @Year, [UnitType] = @UnitType, [Checked] = @Checked, [District] = @District WHERE [SrNo] = @SrNo">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="TotalRs" Type="Double" />
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [diststud]" 
            InsertCommand="INSERT INTO [diststud] ([District], [Taluka], [SchoolType], [Standard]) VALUES (@District, @Taluka, @SchoolType, @Standard)" 
            SelectCommand="SELECT * FROM [diststud]" 
            UpdateCommand="UPDATE [diststud] SET [District] = @District, [Taluka] = @Taluka, [SchoolType] = @SchoolType, [Standard] = @Standard WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [AuthTable]" 
            InsertCommand="INSERT INTO [AuthTable] ([District], [Address], [ContactNo], [EmailID], [Password]) VALUES (@District, @Address, @ContactNo, @EmailID, @Password)" 
            SelectCommand="SELECT * FROM [AuthTable]" 
            UpdateCommand="UPDATE [AuthTable] SET [District] = @District, [Address] = @Address, [ContactNo] = @ContactNo, [EmailID] = @EmailID, [Password] = @Password WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [GauravSevaPadak]" 
            InsertCommand="INSERT INTO [GauravSevaPadak] ([Name], [SchoolName], [Address], [Award], [MeetingDate], [ApplicationDate], [Letter], [Form], [Certificate], [District]) VALUES (@Name, @SchoolName, @Address, @Award, @MeetingDate, @ApplicationDate, @Letter, @Form, @Certificate, @District)" 
            SelectCommand="SELECT * FROM [GauravSevaPadak]" 
            UpdateCommand="UPDATE [GauravSevaPadak] SET [Name] = @Name, [SchoolName] = @SchoolName, [Address] = @Address, [Award] = @Award, [MeetingDate] = @MeetingDate, [ApplicationDate] = @ApplicationDate, [Letter] = @Letter, [Form] = @Form, [Certificate] = @Certificate, [District] = @District WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [HeerakPankh]" 
        ...
        <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [InwardLetters]" 
            InsertCommand="INSERT INTO [InwardLetters] ([LetterAcceptingDate], [LetterNo1], [LetterDate], [LetterFrom], [InLetter], [TopicLetter], [FileNo], [InwardStatus], [District], [OInwardNo]) VALUES (@LetterAcceptingDate, @LetterNo1, @LetterDate, @LetterFrom, @InLetter, @TopicLetter, @FileNo, @InwardStatus, @District, @OInwardNo)" 
            SelectCommand="SELECT * FROM [InwardLetters]" 
            UpdateCommand="UPDATE [InwardLetters] SET [LetterAcceptingDate] = @LetterAcceptingDate, [LetterNo1] = @LetterNo1, [LetterDate] = @LetterDate, [LetterFrom] = @LetterFrom, [InLetter] = @InLetter, [TopicLetter] = @TopicLetter, [FileNo] = @FileNo, [InwardStatus] = @InwardStatus, [District] = @District, [OInwardNo] = @OInwardNo WHERE [InwardNo] = @InwardNo">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="District" Type="String" />
                <asp:Parameter Name="OInwardNo" Type="Int32" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter DbType="Date" Name="LetterAcceptingDate" />
                <asp:Parameter Name="LetterNo1" Type="Int32" />
        ...
        <asp:SqlDataSource ID="SqlDataSource8" runat="server" 
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="SalgnataYear" Type="String" />
                ...
                <asp:Parameter Name="HolidayTakenArjit" Type="Int32" />
                <asp:Parameter Name="HolidayTakenVaidyakiya" Type="Int32" />
                <asp:Parameter Name="HolidayTakenKirkod" Type="Int32" />
                ...
                <asp:Parameter DbType="Date" Name="MaintainanceDate" />
        ...
        <asp:SqlDataSource ID="SqlDataSource9" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [OutwardLetter]" 
            InsertCommand="INSERT INTO [OutwardLetter] ([OutwardDate], [OutwardTo], [OutwardAddress], [Outwardtopic], [OutwardFileNo], [HowSend], [Outletter], [StampUsed], [Ps], [Stamppurchased], [Ps1], [RemainingStamp], [Ps3], [OutwardStatus], [District], [OLetterNo]) VALUES (@OutwardDate, @OutwardTo, @OutwardAddress, @Outwardtopic, @OutwardFileNo, @HowSend, @Outletter, @StampUsed, @Ps, @Stamppurchased, @Ps1, @RemainingStamp, @Ps3, @OutwardStatus, @District, @OLetterNo)" 
            SelectCommand="SELECT * FROM [OutwardLetter]" 
            UpdateCommand="UPDATE [OutwardLetter] SET [OutwardDate] = @OutwardDate, [OutwardTo] = @OutwardTo, [OutwardAddress] = @OutwardAddress, [Outwardtopic] = @Outwardtopic, [OutwardFileNo] = @OutwardFileNo, [HowSend] = @HowSend, [Outletter] = @Outletter, [StampUsed] = @StampUsed, [Ps] = @Ps, [Stamppurchased] = @Stamppurchased, [Ps1] = @Ps1, [RemainingStamp] = @RemainingStamp, [Ps3] = @Ps3, [OutwardStatus] = @OutwardStatus, [District] = @District, [OLetterNo] = @OLetterNo WHERE [OutwardLetterNo1] = @OutwardLetterNo1">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="District" Type="String" />
                <asp:Parameter Name="OLetterNo" Type="Int32" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter DbType="Date" Name="OutwardDate" />
                <asp:Parameter Name="OutwardTo" Type="String" />
        ...
        <asp:SqlDataSource ID="SqlDataSource10" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [RajyaPuraskarGuide]" 
        ...
        <asp:SqlDataSource ID="SqlDataSource11" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [RajyaPuraskarScout]" 
        ...
        <asp:SqlDataSource ID="SqlDataSource12" runat="server" 
            ...
            InsertCommand="INSERT INTO [SchoolTable] ([SchoolType], [Year], [UnitType], [UnitName], [SchoolName], [PermanentAddress], [Taluka], [ContactNo], [EmailId], [Password], [TribleSchool], [Date], [UnitLeaderSignature], [PrincipalSignature], [CharterNo], [WarrantNo], [RegistrationFess], [ReceiptNo], [PayDate], [RegistrationFees1], [ReceiptNo1], [PayDate1], [DistrictSignature], [Zilla], [Status], [FeesPaidMagzine], [Checked], [CheckedMagzine], [khTotalContri], [khUnitContri], [khDistrictContri], [khStateContri], [NoOfStickers], [DhwajStickerFees], [DhwajStickerDistrictLevel], [DhwajStickerStateLevel], [PragatiPatParticipants], [PragatiPatCertificateNo], [PragatiPatDate], [PragatiPatExaminerName], [PragatiPatLetter], [UnitNondaniYear], [UnitNondaniNoOfUnits], [UnitNondaniAmount], [UnitNondaniReceiptNo], [UnitNondaniReceiptNoDate]) VALUES (@SchoolType, @Year, @UnitType, @UnitName, @SchoolName, @PermanentAddress, @Taluka, @ContactNo, @EmailId, @Password, @TribleSchool, @Date, @UnitLeaderSignature, @PrincipalSignature, @CharterNo, @WarrantNo, @RegistrationFess, @ReceiptNo, @PayDate, @RegistrationFees1, @ReceiptNo1, @PayDate1, @DistrictSignature, @Zilla, @Status, @FeesPaidMagzine, @Checked, @CheckedMagzine, @khTotalContri, @khUnitContri, @khDistrictContri, @khStateContri, @NoOfStickers, @DhwajStickerFees, @DhwajStickerDistrictLevel, @DhwajStickerStateLevel, @PragatiPatParticipants, @PragatiPatCertificateNo, @PragatiPatDate, @PragatiPatExaminerName, @PragatiPatLetter, @UnitNondaniYear, @UnitNondaniNoOfUnits, @UnitNondaniAmount, @UnitNondaniReceiptNo, @UnitNondaniReceiptNoDate)" 
            SelectCommand="SELECT * FROM [SchoolTable]" 
            UpdateCommand="UPDATE [SchoolTable] SET [SchoolType] = @SchoolType, [Year] = @Year, [UnitType] = @UnitType, [UnitName] = @UnitName, [SchoolName] = @SchoolName, [PermanentAddress] = @PermanentAddress, [Taluka] = @Taluka, [ContactNo] = @ContactNo, [EmailId] = @EmailId, [Password] = @Password, [TribleSchool] = @TribleSchool, [Date] = @Date, [UnitLeaderSignature] = @UnitLeaderSignature, [PrincipalSignature] = @PrincipalSignature, [CharterNo] = @CharterNo, [WarrantNo] = @WarrantNo, [RegistrationFess] = @RegistrationFess, [ReceiptNo] = @ReceiptNo, [PayDate] = @PayDate, [RegistrationFees1] = @RegistrationFees1, [ReceiptNo1] = @ReceiptNo1, [PayDate1] = @PayDate1, [DistrictSignature] = @DistrictSignature, [Zilla] = @Zilla, [Status] = @Status, [FeesPaidMagzine] = @FeesPaidMagzine, [Checked] = @Checked, [CheckedMagzine] = @CheckedMagzine, [khTotalContri] = @khTotalContri, [khUnitContri] = @khUnitContri, [khDistrictContri] = @khDistrictContri, [khStateContri] = @khStateContri, [NoOfStickers] = @NoOfStickers, [DhwajStickerFees] = @DhwajStickerFees, [DhwajStickerDistrictLevel] = @DhwajStickerDistrictLevel, [DhwajStickerStateLevel] = @DhwajStickerStateLevel, [PragatiPatParticipants] = @PragatiPatParticipants, [PragatiPatCertificateNo] = @PragatiPatCertificateNo, [PragatiPatDate] = @PragatiPatDate, [PragatiPatExaminerName] = @PragatiPatExaminerName, [PragatiPatLetter] = @PragatiPatLetter, [UnitNondaniYear] = @UnitNondaniYear, [UnitNondaniNoOfUnits] = @UnitNondaniNoOfUnits, [UnitNondaniAmount] = @UnitNondaniAmount, [UnitNondaniReceiptNo] = @UnitNondaniReceiptNo, [UnitNondaniReceiptNoDate] = @UnitNondaniReceiptNoDate WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource13" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM StatisticalData" 
            InsertCommand="INSERT INTO [StatisticalData] ([Year], [Cub], [Scout], [Rover], [Bulbul], [Guide], [Ranger], [Bunny], [Total], [Cub1], [Scout1], [Rover1], [Bulbul1], [Guide1], [Ranger1], [Bunny1], [Total1], [TotalUnits], [CollectedFees], [TotalParticipatedSchools], [PrimarySchool], [SecondarySchool], [TotalMembers], [District]) VALUES (@Year, @Cub, @Scout, @Rover, @Bulbul, @Guide, @Ranger, @Bunny, @Total, @Cub1, @Scout1, @Rover1, @Bulbul1, @Guide1, @Ranger1, @Bunny1, @Total1, @TotalUnits, @CollectedFees, @TotalParticipatedSchools, @PrimarySchool, @SecondarySchool, @TotalMembers, @District)" 
            SelectCommand="SELECT * FROM [StatisticalData]" 
            UpdateCommand="UPDATE [StatisticalData] SET [Year] = @Year, [Cub] = @Cub, [Scout] = @Scout, [Rover] = @Rover, [Bulbul] = @Bulbul, [Guide] = @Guide, [Ranger] = @Ranger, [Bunny] = @Bunny, [Total] = @Total, [Cub1] = @Cub1, [Scout1] = @Scout1, [Rover1] = @Rover1, [Bulbul1] = @Bulbul1, [Guide1] = @Guide1, [Ranger1] = @Ranger1, [Bunny1] = @Bunny1, [Total1] = @Total1, [TotalUnits] = @TotalUnits, [CollectedFees] = @CollectedFees, [TotalParticipatedSchools] = @TotalParticipatedSchools, [PrimarySchool] = @PrimarySchool, [SecondarySchool] = @SecondarySchool, [TotalMembers] = @TotalMembers, [District] = @District WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource14" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM SevaPrakalp" 
            InsertCommand="INSERT INTO [SevaPrakalp] ([Year], [SchoolName], [UnitName], [SevaEventName], [SevaEventDate], [SevaAttendance], [SevaDuration], [SevaPlace], [SevaReport], [SevaPhoto], [District]) VALUES (@Year, @SchoolName, @UnitName, @SevaEventName, @SevaEventDate, @SevaAttendance, @SevaDuration, @SevaPlace, @SevaReport, @SevaPhoto, @District)" 
            SelectCommand="SELECT * FROM [SevaPrakalp]" 
            UpdateCommand="UPDATE [SevaPrakalp] SET [Year] = @Year, [SchoolName] = @SchoolName, [UnitName] = @UnitName, [SevaEventName] = @SevaEventName, [SevaEventDate] = @SevaEventDate, [SevaAttendance] = @SevaAttendance, [SevaDuration] = @SevaDuration, [SevaPlace] = @SevaPlace, [SevaReport] = @SevaReport, [SevaPhoto] = @SevaPhoto, [District] = @District WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource15" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM [StudentTable]" 
            InsertCommand="INSERT INTO [StudentTable] ([EmailId], [Password], [Year], [UnitType], [StudFullName], [StudDOB], [StudStandard], [SchoolName], [UnitName], [Status], [District]) VALUES (@EmailId, @Password, @Year, @UnitType, @StudFullName, @StudDOB, @StudStandard, @SchoolName, @UnitName, @Status, @District)" 
            SelectCommand="SELECT * FROM [StudentTable]" 
            UpdateCommand="UPDATE [StudentTable] SET [EmailId] = @EmailId, [Password] = @Password, [Year] = @Year, [UnitType] = @UnitType, [StudFullName] = @StudFullName, [StudDOB] = @StudDOB, [StudStandard] = @StudStandard, [SchoolName] = @SchoolName, [UnitName] = @UnitName, [Status] = @Status, [District] = @District WHERE [SrNo] = @SrNo">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource16" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM UnitInformation" 
            InsertCommand="INSERT INTO [UnitInformation] ([UnitType], [TotalUnits], [TotalStudent], [StudentRegistrationFees], [StudentTotalFees], [TotalUnitLeader], [TotalSupportingLeader], [UnitLeaderRegistrationFees], [UnitLeaderTotalFees], [TotalMembers], [TotalFees], [Year], [District]) VALUES (@UnitType, @TotalUnits, @TotalStudent, @StudentRegistrationFees, @StudentTotalFees, @TotalUnitLeader, @TotalSupportingLeader, @UnitLeaderRegistrationFees, @UnitLeaderTotalFees, @TotalMembers, @TotalFees, @Year, @District)" 
            SelectCommand="SELECT * FROM [UnitInformation]" 
            UpdateCommand="UPDATE [UnitInformation] SET [UnitType] = @UnitType, [TotalUnits] = @TotalUnits, [TotalStudent] = @TotalStudent, [StudentRegistrationFees] = @StudentRegistrationFees, [StudentTotalFees] = @StudentTotalFees, [TotalUnitLeader] = @TotalUnitLeader, [TotalSupportingLeader] = @TotalSupportingLeader, [UnitLeaderRegistrationFees] = @UnitLeaderRegistrationFees, [UnitLeaderTotalFees] = @UnitLeaderTotalFees, [TotalMembers] = @TotalMembers, [TotalFees] = @TotalFees, [Year] = @Year, [District] = @District WHERE [SrNo] = @SrNo">
            <InsertParameters>
                <asp:Parameter Name="UnitType" Type="String" />
                <asp:Parameter Name="TotalUnits" Type="Int32" />
                <asp:Parameter Name="TotalStudent" Type="Int32" />
                <asp:Parameter Name="StudentRegistrationFees" Type="Double" />
                <asp:Parameter Name="StudentTotalFees" Type="Double" />
                <asp:Parameter Name="TotalUnitLeader" Type="Int32" />
                <asp:Parameter Name="TotalSupportingLeader" Type="Int32" />
                <asp:Parameter Name="UnitLeaderRegistrationFees" Type="Double" />
                <asp:Parameter Name="UnitLeaderTotalFees" Type="Double" />
                <asp:Parameter Name="TotalMembers" Type="Int32" />
                <asp:Parameter Name="TotalFees" Type="Double" />
                <asp:Parameter Name="Year" Type="String" />
                <asp:Parameter Name="District" Type="String" />
            </InsertParameters>
            <UpdateParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource17" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            DeleteCommand="DELETE FROM UnitLeaderTable" 
            InsertCommand="INSERT INTO [UnitLeaderTable] ([EmailId], [Password], [District], [Year], [SchoolName], [UnitType], [UnitName], [FullName], [TrainingName], [CertificateNo], [Date], [AdhikarpatraNo], [SupportingLeader], [Status], [SubjectNo], [OptionalSubjectNo], [Attendance], [PantPradhanLetter], [AdhikarCharterNumber], [AdhikarDate], [AdhikarWarrantnumber], [AdhikarRenewalDate], [AdhikarCertificate], [UnitLeaderAddress], [AdarshReceivedDate], [AdarshPlace], [AdarshChiefGuest], [AdarshPhoto], [AdarshCertificate], [AdarshLetter]) VALUES (@EmailId, @Password, @District, @Year, @SchoolName, @UnitType, @UnitName, @FullName, @TrainingName, @CertificateNo, @Date, @AdhikarpatraNo, @SupportingLeader, @Status, @SubjectNo, @OptionalSubjectNo, @Attendance, @PantPradhanLetter, @AdhikarCharterNumber, @AdhikarDate, @AdhikarWarrantnumber, @AdhikarRenewalDate, @AdhikarCertificate, @UnitLeaderAddress, @AdarshReceivedDate, @AdarshPlace, @AdarshChiefGuest, @AdarshPhoto, @AdarshCertificate, @AdarshLetter)" 
            SelectCommand="SELECT * FROM [UnitLeaderTable]" 
            UpdateCommand="UPDATE [UnitLeaderTable] SET [EmailId] = @EmailId, [Password] = @Password, [District] = @District, [Year] = @Year, [SchoolName] = @SchoolName, [UnitType] = @UnitType, [UnitName] = @UnitName, [FullName] = @FullName, [TrainingName] = @TrainingName, [CertificateNo] = @CertificateNo, [Date] = @Date, [AdhikarpatraNo] = @AdhikarpatraNo, [SupportingLeader] = @SupportingLeader, [Status] = @Status, [SubjectNo] = @SubjectNo, [OptionalSubjectNo] = @OptionalSubjectNo, [Attendance] = @Attendance, [PantPradhanLetter] = @PantPradhanLetter, [AdhikarCharterNumber] = @AdhikarCharterNumber, [AdhikarDate] = @AdhikarDate, [AdhikarWarrantnumber] = @AdhikarWarrantnumber, [AdhikarRenewalDate] = @AdhikarRenewalDate, [AdhikarCertificate] = @AdhikarCertificate, [UnitLeaderAddress] = @UnitLeaderAddress, [AdarshReceivedDate] = @AdarshReceivedDate, [AdarshPlace] = @AdarshPlace, [AdarshChiefGuest] = @AdarshChiefGuest, [AdarshPhoto] = @AdarshPhoto, [AdarshCertificate] = @AdarshCertificate, [AdarshLetter] = @AdarshLetter WHERE [SrNo] = @SrNo">
            <InsertParameters>
                <asp:Parameter Name="EmailId" Type="String" />
                <asp:Parameter Name="Password" Type="String" />
                <asp:Parameter Name="District" Type="String" />
